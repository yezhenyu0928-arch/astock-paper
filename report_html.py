...
STRAT_META = {
    ...
    "s6_sector@v1": {
        ...
        "tagline": "每周持有近期最强的行业ETF——产业政策利好最终都会体现为行业涨幅动量，本策略以此自动跟随政策与景气主线，弱市切国债ETF。",
        "factors": [("20日动量排名", "40%"), ("60日动量排名", "40%"), ("60日低波动排名", "20%"),
                    ("绝对动量门槛", "最强者20日收益<0 → 切国债ETF")],
        "rebalance": "每周最后交易日 · 持1只 · 池=券商/半导体/医药/消费/军工/新能源/酒/光伏/银行/国债"},
}
